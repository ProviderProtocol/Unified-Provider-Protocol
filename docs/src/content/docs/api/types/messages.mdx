...
<Aside type="note" title="Specification">
  Implements the [UPP Message Types](/spec/llm/messages).
</Aside>
...
abstract class Message {
  ...
  /** Convenience accessor - returns all image blocks */
  get images(): ImageBlock[];

  /** Convenience accessor - returns all audio blocks */
  get audio(): AudioBlock[];

  /** Convenience accessor - returns all video blocks */
