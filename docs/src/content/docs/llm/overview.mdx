...
- Learn about [Messages](/llm/messages/) - the building blocks of conversations
- Understand [Turns](/llm/turns/) - the result of inference calls
- Explore [Streaming](/llm/streaming/) for real-time responses
- Add [Tools](/llm/tools/) for function calling
