---
title: Unified Provider Protocol
description: A first-generation standard for simplifying AI inference and enabling multi-provider interoperability.
template: splash
hero:
  tagline: UPP-1.1 provides uniform interfaces for interacting with LLMs, Embeddings, and Image Generation across providers.
  image:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/providerprotocol/upp
      icon: external
---
...
Modern AI development requires interacting with multiple providers—Anthropic, OpenAI, Google, Stability, and more—each with distinct APIs, authentication schemes, and response formats. **UPP-1.1** solves this by providing a unified protocol.
