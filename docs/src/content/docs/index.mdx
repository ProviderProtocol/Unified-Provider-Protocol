...
template: splash
hero:
  tagline: UPP provides uniform interfaces for interacting with LLMs, Embeddings, and Image Generation across providers.
  actions:
    - text: Get Started
      link: /introduction/
      icon: right-arrow
...
Modern AI development requires interacting with multiple providers—Anthropic, OpenAI, Google, Stability, and more—each with distinct APIs, authentication schemes, and response formats. **UPP** solves this by providing a unified protocol.
