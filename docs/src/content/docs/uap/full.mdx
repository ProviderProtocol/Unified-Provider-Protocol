---
title: "Full UAP Specification"
description: "Complete UAP-1.0.0 specification in a single document."
---

import { Aside, Badge } from '@astrojs/starlight/components';

# UAP-1.0.0 Full Specification

<Badge text="Version 1.0.0" variant="note" />
<Badge text="Status: Approved" variant="success" />

<Aside type="tip">
  This is the complete UAP specification in a single document. For easier navigation, use the sidebar to browse individual sections.
</Aside>
