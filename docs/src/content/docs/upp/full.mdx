---
title: "Full UPP Specification"
description: "Complete UPP-1.3.0 specification in a single document."
---

import { Aside, Badge } from '@astrojs/starlight/components';

# UPP-1.3.0 Full Specification

<Badge text="Version 1.3.0" variant="note" />
<Badge text="Status: Draft" variant="caution" />

<Aside type="tip">
  This is the complete UPP specification in a single document. For easier navigation, use the sidebar to browse individual sections.
</Aside>
